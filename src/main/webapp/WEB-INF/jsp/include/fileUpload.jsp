...
<script src="<c:url value='/js/hsms/fileUpload/fileUpload.js'/>"></script>
...
<div id="fileUploadModule">
	...
	<div align="right">
		...
		<input type="button" onclick="fileDel();" value="삭제" class="btn btn-sm btn-secondary"  style="margin-left:1px;">
	</div>
	<div class="fileListForm" id="dropZone"">
		<!-- 파일리스트 필드 -->
		<div id="fileListFieldSet">
			<div class="fileLine">
       		 <span class="fileSelect"><input type="checkbox" id="fileAllSelect"></span>
